package com.bilgeadam.newcoursecatalog.controller;

import com.bilgeadam.newcoursecatalog.pojo.Course;
...
public class CatalogController {
    ...
    public String helloCourseWithEureka() {
       ...
       // String courseAppURL = "http://localhost:6161/api/v1";
        ...
        courseAppMessage = instanceInfo.getHomePageUrl();
    ...
    public Course firstCourse()
    {
        ...
        Course firstCourse = restTemplate.getForObject(courseAppURL + "/api/v1/course", Course.class);
